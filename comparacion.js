...
//creacion de elementos - manipulacion del DOM
for (const miResultado of fechaMiResultado) {
    let div = document.createElement("div");
    div.innerHTML = `<label id="partido">PARTIDO 1</label>
                        <ul>
                            <li>
                                <ul>
                                    <li><label id="equipoLocal">${miResultado.equipoLocal}</label></li>
                                    <li><input id="golesA" type="number">${miResultado.golesLocal}</li>
                                </ul>
                            </li>
                            <li>VS</li>
                            <li>
                                <ul>
                                    <li><label id="equipoVisitante">${miResultado.equipoVisitante}</label></li>
                                    <li><input id="golesB" type="number">${miResultado.golesVisitante}</li>
                                </ul>
                            </li>
                        </ul>
                        <ul>
                            <li>Hora: ${miResultado.partidoHora}</li>
                            <li>Estadio: ${miResultado.partidoEstadio}</li>
